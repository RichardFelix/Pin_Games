var oe=Object.defineProperty;var ne=(r,n,t)=>n in r?oe(r,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[n]=t;var e=(r,n,t)=>(ne(r,typeof n!="symbol"?n+"":n,t),t),re=(r,n,t)=>{if(!n.has(r))throw TypeError("Cannot "+t)};var o=(r,n,t)=>{if(n.has(r))throw TypeError("Cannot add the same private member more than once");n instanceof WeakSet?n.add(r):n.set(r,t)};var s=(r,n,t)=>(re(r,n,"access private method"),t);(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const c of l.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerpolicy&&(l.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?l.credentials="include":i.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(i){if(i.ep)return;i.ep=!0;const l=t(i);fetch(i.href,l)}})();const mt=`button{display:flex;justify-content:center;align-items:center;position:fixed;bottom:10px;right:10px;border-radius:100px;width:100px;height:100px;background-color:#304fad;cursor:pointer;box-shadow:5px 5px 5px #000;border:none;transition:.5s ease all}button img{height:100%}.filterBtn img,.saveJsonBtn img,.searchBtn img{height:50%}.saveJsonDataOpen{bottom:385px}.filterGamesOpen,.activeMenuBtn{bottom:135px}.searchGamesOpen{bottom:260px}h1{display:flex;justify-content:center;align-content:center;position:fixed;left:50%;right:50%;transform:translate(-50%,-50%);bottom:70vh;color:#fff;width:80vw;text-shadow:5px 5px black;font-size:3em}.addNewGameNoData{left:50%;right:50%;transform:translate(-50%,-50%);bottom:50vh}.activeMenuBtn{background-color:#639}.hide{display:none}
`;var b,ut,y,pt;class le extends HTMLElement{constructor(){super();o(this,b);o(this,y);e(this,"_shadow",this.attachShadow({mode:"open"}));e(this,"data",DATA.dataJson);e(this,"customModal_parent",document.querySelector("custom-modal"));e(this,"addNewBtn");e(this,"saveJsonBtn");e(this,"searchBtn");e(this,"filterBtn");e(this,"hamburgerBtn")}connectedCallback(){s(this,y,pt).call(this)}}b=new WeakSet,ut=function(){this.filterBtn.classList.add("filterGamesOpen"),this.saveJsonBtn.classList.add("saveJsonDataOpen"),this.searchBtn.classList.add("searchGamesOpen"),this.hamburgerBtn.classList.add("hide")},y=new WeakSet,pt=function(){if(this.data.length>0){let t=`
          <style>
              ${mt}
          </style>
...
`;var x,ft;class gt extends HTMLElement{constructor(){super();o(this,x);e(this,"_shadow",this.attachShadow({mode:"open"}));e(this,"gamesArr",[DATA.installedArr,DATA.playLaterArr,DATA.wishlistArr]);e(this,"headerArr",["Installed","Play Later","Wishlist"]);e(this,"customModal",document.querySelector("custom-modal"))}connectedCallback(){s(this,x,ft).call(this)}attributeChangedCallback(t,a,i){}static get observedAttributes(){return["open"]}}x=new WeakSet,ft=function(){let t="",a=0;this.gamesArr.forEach(i=>{if(i.length>0){let l="",c="";i.forEach(v=>{l+=`
                <game-card 
                    id="${v.name}"
                    name="${v.name}"
...
`;var w,Bt,L,vt;class ce extends gt{constructor(){super();o(this,w);o(this,L);e(this,"gameImage")}connectedCallback(){s(this,L,vt).call(this)}attributeChangedCallback(t,a,i){}static get observedAttributes(){return["hide"]}}w=new WeakSet,Bt=function(){let t=this.getAttribute("id");this.customModal.setAttribute("open","editGame"),this.customModal.setAttribute("name",`${t}`)},L=new WeakSet,vt=function(){let t=this.getAttribute("name"),a=this.getAttribute("imageLocation"),i=this.getAttribute("platform");this._shadow.innerHTML=`
        <style>
            ${de}
        </style>
...
`;var h,d,I,bt,A,yt;class u extends HTMLElement{constructor(){super();o(this,h);o(this,I);o(this,A);e(this,"_shadow",this.attachShadow({mode:"open"}));e(this,"gameCard_parent",document.querySelector("game-section").shadowRoot);e(this,"menuBtns_parent",document.querySelector("menu-btns").shadowRoot);e(this,"saveMenuBtn_parent",this.menuBtns_parent.getElementById("saveJsonBtn"));e(this,"searchMenuBtn_parent",this.menuBtns_parent.getElementById("searchBtn"));e(this,"filterMenuBtn_parent",this.menuBtns_parent.getElementById("filterBtn"));e(this,"addNewGameBtn_parent",this.menuBtns_parent.getElementById("addNewBtn"));e(this,"hamburgerMenuBtn_parent",this.menuBtns_parent.getElementById("hamburgerBtn"));e(this,"data",DATA.dataJson);e(this,"gameImageCount",this.data.length);e(this,"platforms",DATA.PLATFORMS);e(this,"category",DATA.CATEGORY);e(this,"filterGames");e(this,"searchGames");e(this,"saveData");e(this,"editGame");e(this,"addGame");e(this,"commonStyles",`${ue}`)}connectedCallback(){s(this,A,yt).call(this)}attributeChangedCallback(t,a,i){if(a!==i){if(t==="open")switch(this.filterGames.removeAttribute("open"),this.searchGames.removeAttribute("open"),this.saveData.removeAttribute("open"),this.editGame.removeAttribute("open"),this.addGame.removeAttribute("open"),i){case"filter":this.filterGames.setAttribute("open","");break;case"search":this.searchGames.setAttribute("open","");break;case"saveData":this.saveData.setAttribute("open","");break;case"editGame":this.editGame.setAttribute("open","");break;case"addGame":this.addGame.setAttribute("open","");break}t==="close"&&s(this,h,d).call(this),t==="name"&&i!==null&&this.editGame.setAttribute("name",this.getAttribute("name"))}}static get observedAttributes(){return["open","name","close"]}}h=new WeakSet,d=function(){this.hasAttribute("open")&&this.removeAttribute("open"),this.hasAttribute("name")&&this.removeAttribute("name"),this.editGame.hasAttribute("name")&&this.editGame.removeAttribute("name"),s(this,I,bt).call(this)},I=new WeakSet,bt=function(){this.gameImageCount!==0&&(this.filterMenuBtn_parent.classList.contains("activeMenuBtn")===!0?this.searchMenuBtn_parent.classList.remove("searchGamesOpen"):(this.filterMenuBtn_parent.classList.remove("filterGamesOpen"),this.searchMenuBtn_parent.classList.remove("searchGamesOpen")),this.saveMenuBtn_parent.classList.remove("saveJsonDataOpen"),this.hamburgerMenuBtn_parent.classList.remove("hide"))},A=new WeakSet,yt=function(){this._shadow.innerHTML=`
        <style>
            ${me}
        </style>
      ...
      `;let t=this.shadowRoot.querySelector("#closeBtn"),a=this.shadowRoot.querySelector("#backdrop");this.editGame=this.shadowRoot.querySelector("edit-game"),this.filterGames=this.shadowRoot.querySelector("filter-games"),this.searchGames=this.shadowRoot.querySelector("search-games"),this.saveData=this.shadowRoot.querySelector("save-data"),this.addGame=this.shadowRoot.querySelector("add-game"),t.onclick=()=>s(this,h,d).call(this),a.onclick=()=>s(this,h,d).call(this),document.onkeydown=i=>{let l=document.querySelector("custom-modal");i.key=="Escape"&&(l.hasAttribute("close")?l.removeAttribute("close"):l.setAttribute("close",""))},this.filterGames.addEventListener("closeModal",s(this,h,d).bind(this)),this.searchGames.addEventListener("closeModal",s(this,h,d).bind(this)),this.saveData.addEventListener("closeModal",s(this,h,d).bind(this)),this.editGame.addEventListener("closeModal",s(this,h,d).bind(this)),this.addGame.addEventListener("closeModal",s(this,h,d).bind(this))};const pe=`:host([open]){display:flex}input{margin:10px}
`;var g,ht,S,xt,T,wt,E,Lt,G,It;class ge extends u{constructor(){super();o(this,g);o(this,S);o(this,T);o(this,E);o(this,G);e(this,"datalistInput");e(this,"datalistGames");e(this,"searchBtn");e(this,"clearSearchBtn")}connectedCallback(){s(this,G,It).call(this)}attributeChangedCallback(t,a,i){a!==i&&t==="open"&&(this.datalistInput.value="",this.datalistInput.focus(),this.datalistInput.classList.remove("error"))}static get observedAttributes(){return["open"]}}g=new WeakSet,ht=function(){const t=new Event("closeModal");this.dispatchEvent(t)},S=new WeakSet,xt=function(t){t.preventDefault();let a=this.data.filter(i=>i.name.toLowerCase().includes(this.datalistInput.value.toLowerCase()));if(a.length>0&&this.datalistInput.value.length>0){for(let i=0;i<this.gameImageCount;i++)this.gameCard_parent.querySelectorAll("game-card")[i].setAttribute("hide","");a.forEach(i=>{this.gameCard_parent.getElementById(`${i.name}`).removeAttribute("hide")}),this.searchMenuBtn_parent.classList.add("searchGamesOpen"),this.searchMenuBtn_parent.classList.add("activeMenuBtn"),this.filterMenuBtn_parent.classList.remove("activeMenuBtn"),this.clearSearchBtn.removeAttribute("disabled"),s(this,g,ht).call(this)}else this.datalistInput.classList.add("error")},T=new WeakSet,wt=function(t){t.preventDefault();for(let a=0;a<this.gameImageCount;a++)this.gameCard_parent.querySelectorAll("game-card")[a].removeAttribute("hide");s(this,g,ht).call(this),this.searchMenuBtn_parent.classList.remove("activeMenuBtn"),this.clearSearchBtn.setAttribute("disabled","true")},E=new WeakSet,Lt=function(){this.datalistInput.classList.remove("error")},G=new WeakSet,It=function(){this._shadow.innerHTML=`
        <style>    
            ${pe}
            ${this.commonStyles}
        </style>
...
`;var f,dt,k,At,M,St,C,Tt,D,Et;class Be extends u{constructor(){super();o(this,f);o(this,k);o(this,M);o(this,C);o(this,D);e(this,"clearFilterBtn");e(this,"filterBtn");e(this,"platformsSelectBx")}connectedCallback(){s(this,D,Et).call(this)}attributeChangedCallback(t,a,i){}static get observedAttributes(){return["open"]}}f=new WeakSet,dt=function(){const t=new Event("closeModal");this.dispatchEvent(t)},k=new WeakSet,At=function(t){return new Promise((a,i)=>{let l=this.data.filter(c=>c.platform===t.platformFilter);a(l)}).catch(a=>{console.log(`filterGamesLogic function failed - ${a}`),reject(a)})},M=new WeakSet,St=async function(){let t=await s(this,k,At).call(this,{platformFilter:this.platformsSelectBx.value});for(let a=0;a<this.gameImageCount;a++)this.gameCard_parent.querySelectorAll("game-card")[a].setAttribute("hide","");t.forEach(a=>{this.gameCard_parent.getElementById(`${a.name}`).removeAttribute("hide")}),this.filterMenuBtn_parent.classList.add("filterGamesOpen"),this.filterMenuBtn_parent.classList.add("activeMenuBtn"),this.searchMenuBtn_parent.classList.remove("activeMenuBtn"),this.clearFilterBtn.removeAttribute("disabled"),s(this,f,dt).call(this)},C=new WeakSet,Tt=function(){for(let t=0;t<this.gameImageCount;t++)this.gameCard_parent.querySelectorAll("game-card")[t].removeAttribute("hide");this.filterMenuBtn_parent.classList.remove("activeMenuBtn"),this.clearFilterBtn.setAttribute("disabled","true"),s(this,f,dt).call(this)},D=new WeakSet,Et=function(){this._shadow.innerHTML=`
        <style>    
            ${fe}
            ${this.commonStyles}
        </style>
...
`;var P,Gt,R,kt,F,Mt,$,Ct,_,Dt,N,Pt;class be extends u{constructor(){super();o(this,P);o(this,R);o(this,F);o(this,$);o(this,_);o(this,N);e(this,"pathDiv");e(this,"filePathTxt");e(this,"clearPathBtn");e(this,"styledFileBtn");e(this,"hiddenFileInput");e(this,"saveJsonBtn")}connectedCallback(){s(this,N,Pt).call(this)}attributeChangedCallback(t,a,i){a!==i&&t==="open"&&(this.filePathTxt.value="",this.pathDiv.classList.remove("error"))}static get observedAttributes(){return["open"]}}P=new WeakSet,Gt=function(){const t=new Event("closeModal");this.dispatchEvent(t)},R=new WeakSet,kt=function(t){t.preventDefault(),this.filePathTxt.value=""},F=new WeakSet,Mt=function(t){t.preventDefault(),this.pathDiv.classList.remove("error"),this.hiddenFileInput.click()},$=new WeakSet,Ct=function(t){if(t.target.files.length>0){let a=t.target.files[0].path,i=a.substring(0,a.lastIndexOf("\\")+1);this.filePathTxt.value=`${i}`}},_=new WeakSet,Dt=async function(t){if(t.preventDefault(),this.filePathTxt.value.length>0){let a=encodeURI(this.filePathTxt.value);await fetch(`/saveData/${a}`),s(this,P,Gt).call(this)}else this.pathDiv.classList.add("error")},N=new WeakSet,Pt=function(){this._shadow.innerHTML=`
        <style>    
            ${ve}
            ${this.commonStyles}
        </style>
      ...
      `,this.pathDiv=this.shadowRoot.getElementById("pathDiv"),this.filePathTxt=this.shadowRoot.getElementById("filePathTxt"),this.clearPathBtn=this.shadowRoot.getElementById("clearPathBtn"),this.styledFileBtn=this.shadowRoot.getElementById("styledFileBtn"),this.hiddenFileInput=this.shadowRoot.getElementById("hiddenFileInput"),this.saveJsonBtn=this.shadowRoot.getElementById("saveJsonBtn"),this.clearPathBtn.onclick=t=>s(this,R,kt).call(this,t),this.styledFileBtn.onclick=t=>s(this,F,Mt).call(this,t),this.hiddenFileInput.onchange=t=>s(this,$,Ct).call(this,t),this.saveJsonBtn.onclick=t=>s(this,_,Dt).call(this,t)};const ye=`:host([open]){display:flex}.nameTxt{width:85%;align-self:center}.pathDiv{display:flex;align-items:center;margin:0 auto}.filePathLbl{margin:15px 0 0}.filePathTxt{background-color:#cdd2d7;border:none;padding:8px 20px}.clearPathBtn{border-radius:5px;padding:8px}.submitBtns{display:flex;justify-content:center;align-items:center;width:90%;margin:20px auto}.updateBtn{margin:auto}.deleteBtn,.updateBtn{margin:10px}
`;var O,Ft,H,$t,q,_t,J,Nt,j,Ot,U,Ht,z,qt,B,ct,V,Jt,K,jt;class Rt extends u{constructor(){super();o(this,O);o(this,H);o(this,q);o(this,J);o(this,j);o(this,U);o(this,z);o(this,B);o(this,V);o(this,K);e(this,"nameTxt");e(this,"platformsSelectBx");e(this,"categorySelectBx");e(this,"filePathTxt");e(this,"clearPathBtn");e(this,"styledFileBtn");e(this,"hiddenFileInput");e(this,"deleteBtn");e(this,"updateBtn");e(this,"currentGame");e(this,"form");e(this,"playGame")}connectedCallback(){s(this,K,jt).call(this)}attributeChangedCallback(t,a,i){a!==i&&(t==="open"&&(s(this,B,ct).call(this),this.nameTxt.classList.remove("error"),this.nameTxt.focus()),t==="name"&&i!==null&&s(this,z,qt).call(this,i))}static get observedAttributes(){return["open","name"]}}O=new WeakSet,Ft=function(){const t=new Event("closeModal");this.dispatchEvent(t)},H=new WeakSet,$t=function(t){t.preventDefault(),this.filePathTxt.value=""},q=new WeakSet,_t=function(t){t.preventDefault(),this.hiddenFileInput.click()},J=new WeakSet,Nt=function(t){t.target.files.length>0&&(this.filePathTxt.value=`${t.target.files[0].path}`)},j=new WeakSet,Ot=async function(t){if(this.nameTxt.value.length>0){t.preventDefault();const a={name:this.nameTxt.value,platform:this.platformsSelectBx.value,category:this.categorySelectBx.value,path:this.filePathTxt.value};await fetch(`/${this.currentGame.id}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}).then(()=>{this.currentGame="",window.location.href="/"})}else this.nameTxt.classList.add("error"),this.nameTxt.focus()},U=new WeakSet,Ht=async function(t){t.preventDefault();const a={name:this.nameTxt.value,category:this.categorySelectBx.value};await fetch(`/${this.currentGame.id}`,{method:"DELETE",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}).then(()=>{this.currentGame="",window.location.href="/"})},z=new WeakSet,qt=function(t){this.currentGame=this.data.filter(a=>a.name.toLowerCase()===t.toLowerCase()),this.currentGame=this.currentGame[0],this.categorySelectBx.value=this.currentGame.category,this.nameTxt.value=this.currentGame.name,this.platformsSelectBx.value=this.currentGame.platform,this.filePathTxt.value="",this.currentGame.path!==void 0&&this.currentGame.path!==""&&(this.filePathTxt.value=this.currentGame.path,this.playGame.setAttribute("open",""),this.playGame.setAttribute("name",`${this.currentGame.name}`),this.playGame.setAttribute("filePath",`${this.filePathTxt.value}`),this.form.classList.add("hide"))},B=new WeakSet,ct=function(){this.form.classList.remove("hide"),this.playGame.removeAttribute("name"),this.playGame.removeAttribute("open"),this.playGame.removeAttribute("filePath")},V=new WeakSet,Jt=function(){s(this,B,ct).call(this)},K=new WeakSet,jt=function(){this._shadow.innerHTML=`
        <style>    
            ${ye}
            ${this.commonStyles}
        </style>
...
`;var Z,Wt,tt,Yt,et,Qt,m,p,at,Xt,st,Zt,it,te,ot,ee,nt,ae,rt,se,lt,ie;class Ie extends u{constructor(){super();o(this,Z);o(this,tt);o(this,et);o(this,m);o(this,at);o(this,st);o(this,it);o(this,ot);o(this,nt);o(this,rt);o(this,lt);e(this,"searchLogoArr",[]);e(this,"searchLogoCounter",0);e(this,"form");e(this,"nameTxt","wat");e(this,"platformsSelectBx");e(this,"categorySelectBx");e(this,"logoDiv");e(this,"searchForCoverBtn");e(this,"coverDiv");e(this,"leftArrowBtn");e(this,"rightArrowBtn");e(this,"coverArtImagesDiv");e(this,"coverTxt");e(this,"logoSearchImgs");e(this,"logoSearchImgSolo");e(this,"styledUploadCoverBtn");e(this,"hiddenUploadCoverInput");e(this,"filePathTxt");e(this,"clearPathBtn");e(this,"styledFileBtn");e(this,"hiddenFileInput");e(this,"saveBtn");e(this,"loadingSVG",`<svg width="300" height="120" id="clackers" class="clackers hide">
    <!-- Left arc path -->
    <svg>
